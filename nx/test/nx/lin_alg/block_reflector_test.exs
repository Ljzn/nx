defmodule NxLinAlg.EigBlockReflectorTest do
  ...
  describe "dlarfb/4" do
    test "left application" do
      ...
      h_block = Nx.subtract(Nx.eye(3, type: :f64),
